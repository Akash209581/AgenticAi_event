export const eventsRulesData = {
  ...
  'technical-1': {
    ...
    rules: [
      ...
      'Team Composition: 4 to 5 members per team (strictly 4 members required, 5th member optional). Open to students of any academic year.',
  ...
  'creative-1': {
    ...
    judgingCriteria: [
      ...
      'Relevance to Theme "AI for Society" (25%)',
      'Effective Use of AI Tools (20%)',
      'Storytelling & Visual Quality (15%)',
  ...
  'creative-3': {
    ...
    rules: [
      ...
      'Competition Duration: 80 to 100 minutes.',
      'No external AI tools (ChatGPT, Gemini, Copilot, Claude, DeepSeek, etc.) permitted during competition.',
      'Internet access, books, notes, and external references are strictly prohibited.',
      'Discussion is allowed only within your own registered team.',
      'Once an answer is submitted, it cannot be changed.',
      'Maintain academic integrity and discipline.',
...
export function getEventDetails(categoryId, eventId, fallbackTitle = '') {
  ...
  return {
    ...
    categoryName: `${categoryId.toUpperCase()} EVENTS`,
    title: fallbackTitle || 'EVENT RULES & GUIDELINES',
    cardTitle: fallbackTitle || 'EVENT RULES',
    image: '/images/event_hackathon_1786084020517.png',
    rules: [
      'Participants must register before the event deadline.',
      'Must carry valid Student/University ID card for verification.',
      'Maintain discipline and follow official coordinator instructions.',
