...
export const EVENT_DEADLINES = {
  ...
  'creative-3': '28 August 2026, 4:00 PM', // AGENTIC DAY QUIZ CHALLENGE 2026
  'creative-4': 'closed',                  // QUESTX
 ...
 * If time is not specified in the string, sets to end of day 23:59:59.999.
...
export function isEventRegistrationClosed(eventId = '', eventTitle = '', rawDeadline = null) {
  ...
  if (!deadlineStr) {
    if (EVENT_DEADLINES[id]) {
      ...
      deadlineStr = 'closed';
    } else if (t.includes('quiz') || id === 'creative-3') {
      deadlineStr = '28 August 2026, 4:00 PM';
